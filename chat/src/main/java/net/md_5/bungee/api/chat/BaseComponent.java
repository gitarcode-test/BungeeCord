...
public abstract class BaseComponent {
  ...
  @Getter private ComponentStyle style = new ComponentStyle();

  /**
   * The text to insert into the chat when this component (and child components) are clicked while
  ...
  @Getter private transient boolean reset;
   ...
   *
   * @param component the component to copy from
   * @param replace if already set formatting should be replaced by the new component
   */
   ...
   *
   * <p>Unlike {@link #applyStyle(ComponentStyle)}, this method will overwrite all style values on
   * this component.
   *
   ...
   *
   * <p><b>Warning: This should be a color, not formatting code (ie, {@link ChatColor#color} should
   * not be null).</b>
   *
  ...
  /**
   * Returns the font of this component. This uses the parent's font if this component doesn't have
   * one.
   *
  ...
  /**
   * Returns whether this component is bold. This uses the parent's setting if this component hasn't
   * been set. false is returned if none of the parent chain has been set.
   *
  ...
  /**
   * Returns whether this component is underlined. This uses the parent's setting if this component
   * hasn't been set. false is returned if none of the parent chain has been set.
   *
  ...
  /**
   * Returns whether this component is underlined without checking the parents setting. May return
   * null
   *
   * @return whether the component is underlined
   */
  ...
  /**
   * Returns whether this component is strikethrough without checking the parents setting. May
   * return null
   *
   * @return whether the component is strikethrough
   */
  ...
  /**
   * Returns whether this component is obfuscated. This uses the parent's setting if this component
   * hasn't been set. false is returned if none of the parent chain has been set.
   *
  ...
  /**
   * Returns whether this component is obfuscated without checking the parents setting. May return
   * null
   *
   * @return whether the component is obfuscated
   */
   ...
   *
   * <p>Any style values that have been explicitly set in the style will be applied to this
   * component. If a value is not set in the style, it will not override the style set in this
   * component.
   *
  ...
  public boolean hasFormatting() {
    return hasStyle() || insertion != null || hoverEvent != null || clickEvent != null;
  }
